...
const TemplateScreen = ({navigation}) => {
  ...
  const onCreateTemplate = () => {
    ...
    setLoading(true);
    dispatch(createTemplate(FORM.templateForm))
      .then(response => {
        dispatch(resetTemplateForm());
        setLoading(false);
        setVisible(!visible);
        ...
        <ScrollView>
          <View style={styles.container}>
            <CustomModal
              isVisible={!visible}
              alertLabel="Success!"
              alertMsg="Your template was successfully created."
              buttonText="Back To Template"
              onPress={() => {
                setVisible(!visible);
            ...
            <View style={styles.colTop}>
              <View>
                <TouchableOpacity
                  ...
                  />
                  <Text style={styles.pageLabel}>Create Template</Text>
                </TouchableOpacity>
              </View>
